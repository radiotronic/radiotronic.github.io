...
<head>
<meta charset="utf-8">
<title><?php echo $page_title; ?> - <?php echo $menu_sobre; ?></title>
      ...
      <div class="nav_wrapper">
        <div class="nav_scroll">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="sobre.php"><?php echo $menu_sobre; ?></i></a></li>
             ...
             <div class="container">
                  <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <h1>A rádio</h1>
                          <h5>Sobre a <?php echo $page_title; ?></h5>
                      </div>                  
                  </div>
             </div>
        </section>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                          ...
                          <?php include_once($_SERVER["DOCUMENT_ROOT"]."/admin/data/blocks/sobre.html"); ?>                  
                          </article><!--\\latest post-->
