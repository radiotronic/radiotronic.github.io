...
<head>
<meta charset="utf-8">
<title><?php echo $page_title; ?> - <?php echo $menu_fotos; ?></title>
      ...
      <div class="nav_wrapper">
        <div class="nav_scroll">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="fotos.php"><?php echo $menu_fotos; ?></a></li>
      ...
      <section id="recent-albums">
          <div class="container">
              <div class="recent-album-list">
                  ...
                  <?php $gallery ="Fotos"; include($_SERVER["DOCUMENT_ROOT"]."/admin/includes/gallery2.php"); ?>
