...
<head>
<meta charset="utf-8">
<title><?php echo $page_title; ?> - <?php echo $menu_noticias; ?></title>
      ...
      <div class="nav_wrapper">
        <div class="nav_scroll">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="noticias.php"><?php echo $menu_noticias; ?></i></a></li>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9">
                          ...
                          <?php include_once($_SERVER["DOCUMENT_ROOT"]."/admin/includes/news2.php"); ?>
